...
This repo documents Week 2 of my cybersecurity internship at Networkwalks. Where Week 1 was all about setting up the lab environment, Week 2 was the first actual recon work — running a set of standard passive OSINT tools against a real, live domain (networkwalks.com, with permission from Networkwalks) to see what's exposed publicly before any active testing would ever come into the picture.

Everything I ran here is passive. WHOIS lookups, DNS enumeration, HTTP header checks, WAF fingerprinting. No exploitation, no injection, nothing that touches the target any more than a normal visitor's browser or DNS resolver would.

**This was run with explicit permission on a domain belonging to my internship provider. I don't run these tools against domains I don't have permission to test.**
...
**Week:** 2 | **Project:** Passive Reconnaissance & OSINT
